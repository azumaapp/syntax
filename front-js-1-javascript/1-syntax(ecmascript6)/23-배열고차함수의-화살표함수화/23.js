...
// arr.reduce((acc, item) => acc + item) // sum // * return이 있을 시, 더 깔끔하게 변경이 가능하다.
// arr.reduce((acc, item) => acc + item / arr.length) // average // * return이 있을 시, 더 깔끔하게 변경이 가능하다.
// arr.reduce((accumluate, value, index, array) => accumluate + value ) // * return이 있을 시, 더 깔끔하게 변경이 가능하다.
...
// console.log(arr.findIndex((item) => item > 3)) // * return이 있을 시, 더 깔끔하게 변경이 가능하다.
