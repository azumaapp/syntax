...
$sqlall = "SELECT * FROM `azuma_a_blog1` where del_flg = '0'";
$count = mysqli_query($conn, $sqlall)->num_rows;
$end_page = ceil($count/3);
// ▲ ★ 넘기는 개수 수정할 때 맨 끝 숫자 수정

$sql = "SELECT * FROM `azuma_a_blog1` where del_flg = '0' order by no desc limit $start, 3";
// ▲ ★ 넘기는 개수 수정할 때 맨 끝 숫자 수정
// ▲ limit a, 5 = a 부터 5개
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-9">
              ...
              <?php } ?>
                      ...
                      <div class="blog-content">
                          ...
                          <div class="post-meta d-flex mb-30">
                            ...
                            <p class="tags">in<a href="blog1.php"> Project Blog</a></p> <!-- BBSID -->
              ...
              <!-- 로그인 한 경우 -->
                <br><br>
                <button onclick="location.href='blog1_write.php'">등록</button>&nbsp;
                <button onclick="location.href='blog1_modify.php?no=<?=$v['no']?>'">수정</button>&nbsp;
                <button onclick="location.href='_blog1_delete.php?no=<?=$v['no']?>'">삭제</button>&nbsp;
              <?php
                  } else {
              ?>
              <!-- 로그인 안한 경우 -->
                    ...
                    <div class="oneMusic-pagination-area wow fadeInUp" data-wow-delay="300ms">
                        <nav>
                            <ul class="pagination">
                              ...
                              <?php } else { ?>
                                  <li class="page-item"><a class="page-link" href="blog1.php?current_page=1">&laquo;</a></li>
                                  <li class="page-item"><a class="page-link" href="blog1.php?current_page=<?=$prev_page?>">앞</a></li>
                              <?php } ?>
                              ...
                              <?php } else { ?>
                                  <li class="page-item"><a class="page-link" href="blog1.php?current_page=<?=$next_page?>">뒤</a></li>
                                  <li class="page-item"><a class="page-link" href="blog1.php?current_page=<?=$end_page?>">&raquo;</a></li>
                              <?php } ?>
                            </ul>
                        </nav>
                    </div>
