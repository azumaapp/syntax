<?php
    ...
    if(isset($img1)) {
        ...
        if(move_uploaded_file($tmp_name1, $dir.$file_name1)) {
              // 파일 입력 성공시
              require('_conn.php');
              $sql = "INSERT INTO `azuma_a_blog1` (`no`, `title`, `content`, `nickname`, `reg_date`, `update_date`, `img_file1`, `img_size1`, `del_flg`) VALUES (NULL, '$title', '$content', '$nickname', current_timestamp(), NULL, '$file_name1', '$img_size1', '0')";
              mysqli_query($conn, $sql);
              header("refresh:0.1; url=blog1.php");

        // 파일 입력 실패시
        } else {
            require('_conn.php');
            $sql = "INSERT INTO `azuma_a_blog1` (`no`, `title`, `content`, `nickname`, `reg_date`, `update_date`, `img_file1`, `img_size1`, `del_flg`) VALUES (NULL, '$title', '$content', '$nickname', current_timestamp(), NULL, NULL, NULL, '0')";
            mysqli_query($conn, $sql);
            header("refresh:0.1; url=blog1.php");
            }
